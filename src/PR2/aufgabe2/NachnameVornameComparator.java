...
/**
 * Diese Klasse repr�sentiert den Nachname/Vorname-Comparator (Vergleich von
 * Vor- und Nachnamen)
 *
...
public class NachnameVornameComparator implements Comparator<Customer> {
    ...
    /**
     * Override Compare f�r Nachname/Vorname Override Compare f�r
     * Nachname/Vorname
     *
     * @param Customer arg0, Customer arg1
     *                 -> repr�sentiert die beiden Kundenobjekte
     *                 die verglichen werden
     * @return result
     * -> repr�sentiert den Ergebniswert aus dem Vergleich
     */
