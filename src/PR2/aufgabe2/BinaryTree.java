...
public class BinaryTree<T, U> {
     ...
     *
     * @param neu     -> repr�sentiert den neuen Knoten
     * @param current -> repr�sentiert den aktuellen Knoten
     * @throws NodeException -> Kann eine NodeException werfen wenn ein Knoten bereits mit
     *                       demselben Schl�ssel vorhanden ist
     */
    ...
    /**
     * Aufruf der Hilfsmethode findKeyHelper um einen Schl�ssel zu finden
     *
     * @param givenKey -> Schluessel zum gesuchten Wert
     */
     ...
     * Wert.
     *
     * @param nodeFind -> repr�sentiert den gesuchten Knotenschl�ssel
     * @param current  -> repr�sentiert den aktuellen Knoten
     * @return value -> repr�sentiert den gesuchten Wert
     */
    @SuppressWarnings("unchecked")
