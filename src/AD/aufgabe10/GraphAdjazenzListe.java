...
public class GraphAdjazenzListe<T> implements IGraph<T> {
    ...
    public void addKante(Knoten<T> start, Knoten<T> ende, double wert) {
        ...
        if (firstNodeIndex >= 0 && secondNodeIndex >= 0) {
            //wir holen uns die Listen der Knoten und "verbinden" / fuegen die neue Liste der Kante mit den Indicies der Knoten hinzu.
     ...
     */
    protected Kante getKante(int indexStartKnoten, int indexZielKnoten) {
